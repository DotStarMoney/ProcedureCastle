...
class Painter::Triangle2DBatch : public Painter::GraphicsBatch<VERTEX_DATA_TYPE>
{	
public:
	Triangle2DBatch() : Painter::GraphicsBatch<VERTEX_DATA_TYPE>() {}
	void addBox(GLfloat _x0, GLfloat _y0, GLfloat _x1, GLfloat _y1, GLfloat _z, glm::vec4& _col)
	{
		GLfloat* vDat;
		GLushort* iDat;
		unsigned int vertS;
